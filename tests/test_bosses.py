...
class TestBossLevels(unittest.TestCase):
    ...
    def test_boss_grid_uses_dedicated_arena(self):
        ...
        grid = BrickGrid(Viewport(1024, 768), level=5, top_n=164, boss_id=boss.boss_id)
    ...
    def test_boss_level_requires_boss_defeat(self):
        ...
        with mock.patch('pygame.display.set_mode'):
            ...
            game.brick_grid = BrickGrid(Viewport(1024, 768), level=5, top_n=game.playfield_top_n + 10, boss_id=game.current_boss_id)
            game.spawn_boss()
